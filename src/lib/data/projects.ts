...
export const projects: Project[] = [
	...
	},
	{
		...
		date: '2022-07-30',
		tags: ['data reporting', 'politics', 'Washington', 'NLP'],
	...
	},
	{
		...
		date: '2024-02-09',
		tags: ['local reporting', 'data reporting', 'mapping', 'investigation'],
	...
	},
	{
		...
		date: '2023-05-20',
		tags: ['data visualization', 'data reporting'],
	...
	},
	{
		...
		description:
			"Led on-the-ground reporting and interviews at multiple campuses while building the first comprehensive database tracking pro-Palestinian protests, arrests, and encampments across U.S. college campuses in spring 2024. Developed methodology for verifying arrest numbers and protest locations across more than 61 campuses, ultimately documenting over 2,950 arrests\u2014data that The New York Times, Al Jazeera, and other major outlets subsequently used to fact-check their own reporting published 48 hours later.\nBuilt a Python-based system using OSINT techniques to automatically identify protest-related data and expedite outreach to university officials for verification. Created an interactive map and database by aggregating information from university statements, police department reports, local news coverage, and direct campus official communications. The breaking news tracking required real-time verification as protests spread rapidly from Columbia University nationwide, establishing Axios as the authoritative source for campus protest data.",
		thumbnail: '/images/campusprotest.png',
		link: 'https://www.axios.com/2024/04/27/palestinian-college-protest-arrest-encampment',
		date: '2024-04-27',
		tags: ['mapping', 'data reporting', 'breaking news', 'svelte', 'higher ed'],
	...
	},
	{
		...
		date: '2024-01-15',
		tags: ['mapping', 'svelte', 'react', 'R', 'node.js'],
	...
	},
	{
		...
		date: '2024-10-17',
		tags: ['data reporting', 'survey', 'criminal justice', 'elections'],
		collaborators: [],
		awards: '',
		featured: true,
		category: 'Data & Analysis'
	},
	{
		...
		date: '2024-04-01',
		tags: ['local reporting', 'adobe illustrator', 'data reporting', 'environmental'],
	...
	},
	{
		...
		description:
			'Analyzed 70+ years of SIPRI arms transfer data with Python and built an interactive Svelte visualization with custom Adobe Illustrator graphics to map U.S. military aid to Israel from 1950 to 2022.',
		thumbnail: '/images/armsisrael.png',
		link: 'https://www.axios.com/2023/11/29/us-weapons-provided-israel-aircraft-missiles-bombs',
		date: '2023-11-29',
		tags: ['foreign policy', 'svelte', 'data reporting', 'python'],
