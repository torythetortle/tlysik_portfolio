...
export const projects: Project[] = [
	{
		...
		link: '',
		date: '2026-01-01',
		tags: ['react', 'pdf.js', 'AI', 'javascript', 'Vite', 'NLP'],
		collaborators: [],
		awards: '',
		featured: true,
		category: 'Research'
	...
	},
	{
		...
		date: '2023-06-01',
		tags: ['SQL', 'web development', 'react', 'svelte', 'Mapbox', 'R', 'APIs', 'web scraping', 'FOIA', 'UI'],
	...
	},
	{
		...
		date: '2024-01-15',
		tags: ['D3', 'svelte', 'react', 'R', 'node.js', 'UI design'],
	...
	},
	{
		...
		date: '2025-04-01',
		tags: ['Dagster', 'ETL', 'Python', 'Observable', 'Adobe Illustrator', 'NLP', 'AI'],
		collaborators: [],
		awards: '',
		featured: true,
		category: 'Data & Analysis'
